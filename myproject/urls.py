...
from mindspaceapp import views
...
urlpatterns = [
    ...
    path('projectpart2/', views.projectpart2_view, name='projectpart2'),
    path('pdashboard/', views.pdashboard_view, name='pdashboard'),
    path('pdashboard/add/', views.add_journal_entry, name='add_journal_entry'),
